#include <Enlivengine/Meta/ObjectEditorSpecialization_Core.hpp>
...
bool ImGuiEditor(en::Entity& object, const char* name)
{
	bool display = true;
...
bool ImGuiEditor(en::EntityManager& object, const char* name)
{
...
bool ImGuiEditor(en::TransformComponent& object, const char* name)
{
	bool modified = false;
...
bool ImGuiEditor(en::CameraComponent& object, const char* name)
{
	bool modified = false;
#ifdef ENLIVE_DEBUG
...
bool ImGuiEditor(en::PhysicComponent2D& object, const char* name)
{
	bool modified = false;
	if (ImGui::CollapsingHeader(name))
	{
