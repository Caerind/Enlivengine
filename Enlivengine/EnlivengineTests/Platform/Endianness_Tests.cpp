...
DOCTEST_TEST_CASE("Endianness swapping")
{
	...
	{
		en::U32 t = 123;
		en::Endian::SwapBytes(nullptr, 0);
		en::Endian::SwapBytes(nullptr, 1);
		en::Endian::SwapBytes(&t, 0);
		DOCTEST_CHECK(t == 123);
					
		en::U8 buf1[1] = { 0xAB };
		en::Endian::SwapBytes(buf1, 1);
		DOCTEST_CHECK(buf1[0] == 0xAB);

		en::U8 buf2[2] = { 0xAB, 0xCD };
		en::Endian::SwapBytes(buf2, 2);
	...
	{
		DOCTEST_CHECK(en::Endian::SwapU16(0xABCD) == 0xCDAB);
		DOCTEST_CHECK(en::Endian::SwapI16(0x1234) == 0x3412);

		DOCTEST_CHECK(en::Endian::SwapU16(en::Endian::SwapU16(0xABCD)) == 0xABCD);
		DOCTEST_CHECK(en::Endian::SwapI16(en::Endian::SwapI16(0x1234)) == 0x1234);
	}

	DOCTEST_SUBCASE("U32 & I32")
	{
		DOCTEST_CHECK(en::Endian::SwapU32(0xABCD1234) == 0x3412CDAB);
		DOCTEST_CHECK(en::Endian::SwapI32(0xABCD1234) == 0x3412CDAB);

		DOCTEST_CHECK(en::Endian::SwapU32(en::Endian::SwapU32(0xABCD1234)) == 0xABCD1234);
		DOCTEST_CHECK(en::Endian::SwapI32(en::Endian::SwapI32(0xABCD1234)) == 0xABCD1234);
	}
