...
DOCTEST_TEST_CASE("Vector2")
{
	...
	DOCTEST_CHECK(en::Vector2f::Equals(v1, en::Vector2f(9.0f / en::Math::FastSqrt(58.0f), 21.0f / en::Math::FastSqrt(58.0f))));
	DOCTEST_CHECK(en::Vector2f::Equals(v2, en::Vector2f(25.000f / en::Math::FastSqrt(146.000f), 55.000f / en::Math::FastSqrt(146.000f))));
	v1.Normalize();
	v2.Normalize();
