...
{
	assert(sizeof(color) >= 3 * sizeof(F32));
	this->r = (U8)(color[0] * 255.0f);
	this->g = (U8)(color[1] * 255.0f);
	this->b = (U8)(color[2] * 255.0f);
	if (sizeof(color) == 3 * sizeof(F32))
	{
		this->a = 255;
	}
	else
	{
		this->a = (U8)(color[3] * 255.0f);
	}
}
