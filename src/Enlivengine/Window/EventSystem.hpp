...
public:
    ...
    static U32 AddTouch(const char* name, U32 finger, EventButton::ActionType action);
    ...
    static const std::vector<std::string>& GetEventsDebug() { return GetInstance().mEventsDebug; }
    static void AddEventDebug(const std::string& eventDebug);
...
private:
    ...
    std::vector<std::string> mEventsDebug;
};
